...
class SinglePost extends React.Component{
  constructor(props){
    ...
    this.state={ id:this.props.match.params.picname,noOfComment:'',cat:'',Category:[],comment:'',pictureComment:[],imageupload:'',username:''}
  ...
  componentDidMount(){
    axios.post("http://localhost:8081/timeline/imageData",this.state).then((response)=>{
    this.setState({Category:response.data})
    this.setState({pictureComment:response.data[0].comment})
    this.setState({imageupload:this.state.Category[0].imageupload})
    this.setState({username:this.state.Category[0].email})
    this.setState({noOfComment:this.state.Category[0].comment.length})
    this.setState({cat:this.state.Category[0].cat})
     //console.log("Single Post data ",this.state.Category[0].imageupload)  
  })
  ...
  handleSubmit=(e)=>{
    ...
    axios.post("http://localhost:8081/timeline/uploadComment",this.state).then((response)=>{
      this.setState({pictureComment:response.data.comment})    
  //console.log("responses",this.state.pictureComment)
    ...
    <div className="container"> 
      <div className="content">
        <div className="content_rgt">
          <div className="rght_btn"><a href="#">Upload Post</a> </div>
           <div className="rght_btn"><a href="#">Upload Category</a> </div>
        ...
        <div className="content_lft">
          <div className="contnt_2">
            <div className="div_a">
              ...
              <div className="div_image"><img src={`http://localhost:8081/${this.state.imageupload}`} alt="abc" /></div>
              <div className="div_btm">
                <div className="btm_list">
                  <ul>
                    ...
                    <li><a href="#"><span className="btn_icon"><img src="/images/icon_004.png" alt="share" /></span>{this.state.noOfComment} Comments</a></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <ul>
              ...
              <li>
                ...
                <input type="button" defaultValue="Reply" className="orng_btn" />
                  ...
                  <div>
                    {this.state.pictureComment.length>0? this.state.pictureComment.map((comm)=>{
                        return(
                          <div>
              <li>
                <div className="list_image">
                ...
                <div className="list_info">{comm}</div>
                <input type="button" defaultValue="Reply" className="orng_btn" />
              </li>
              ...
              <li>
                ...
                <form  onSubmit={this.handleSubmit} type="Submit">
                  <input onChange={this.handleChange} value={this.state.comment} name="comment"  type="text" placeholder="Enter your Comment" className="cmnt_bx1" />
