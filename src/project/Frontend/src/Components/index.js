...
class Index extends React.Component{
    constructor(props){
        super(props);
        this.state={email:"",imageupload:"", userId:"",cat:"",toggle:false,mostCommented:[],picture:[], Category:[],date:new Date(),bool:false,showForm:false}
    }
    ...
    componentDidMount(){
        ...
        axios.post("http://localhost:8081/timeline/getAllPost",this.state).then((response)=>{
...
handleClick=(e)=>{
  ...
  this.setState({showForm:!this.state.showForm})
      ...
      mostCommented=(e)=>{
          ...
          axios.post("http://localhost:8081/timeline/mostCommented").then((response)=>{
            ...
            <div className="container">
              <div className="content">
                  ...
                  <div className="contnt_1">
                    ...
                    <div className="post_div">
                      <div className="post_list">
                        <ul>
                          <li><a href="#" onClick={this.latestFirst}><span className="list_img"><img src="images/img_1.png" /></span>Latest First</a></li>
                          <li><a href="#" onClick={this.oldestFirst}><span className="list_img"><img src="images/img_2.png" /></span>Oldest First</a></li>
                          ...
                          <li><a href="#" onClick={this.mostCommented}><span className="list_img"><img src="images/img_5.png" /></span>Most Commented</a></li>
                        </ul>
                      </div>
                ...
                <div className="div_a">
                  ...
                  <Link to={`/myPost/${pic._id}`}><img style={{width:400 ,height:300}} src={`http://localhost:8081/${pic.imageupload}`} /></Link> <div className="div_btm">
                    ...
                    <h1>{this.state.mostCommented.length>0 ? this.state.mostCommented.map((pic)=>{
                      return(
                        <div>
                        <div className="contnt_2">
                  <div className="div_a">
