                ...
                <div className="content_rgt">
                  <div className="register_sec">
                    ...
                    <ul>
                      ...
                      <li><span>Password</span><input type="text" onChange={this.handleChange} placeholder="Enter your password" name="pass" required/></li>
                      <li><span>Email</span><input type="text" onChange={this.handleChange} placeholder="Enter your email" name="email" required/></li>
